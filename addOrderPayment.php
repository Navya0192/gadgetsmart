...
if (mysqli_query($con, $sql1)) {
  include('db.php');
  $sql99 = "INSERT INTO `order_master`(`OUID`, `Method`, `payment_id`, `towards`, `status`, `custID`,`RegDate`) 
  VALUES (UUID(),'" . $method . "','" . $paymentid . "','Purchase - " . $proName . "','In Transit','" . $custid . "','" . $date . "')";
  if (mysqli_query($con, $sql99)) {
    include('db.php');
    $sql98 = "INSERT INTO `payment`(`payment_id`, `referenceNumber`, `custID`, `towards`, `amount`, `gDate`,`GST`) 
    VALUES ('" . $paymentid . "',UUID(),'" . $custid . "','Purchase - " . $proName . "','" . $amount . "','" . $datetime . "','".$GSTper."')";
