...
include('db.php');
    ...
    $GST = (int)$tempGST;
    $GSTDivide = $GST / 2;
    $gsthalfcalc = $GSTDivide /100 ;
    $gstCalc = $GST/100;
    $newAmount = ($amount-($amount * $gstCalc));
include('db.php');
...
$html.= '                                        <br><b>Tele No : 0824-4280428<br>Phone : +91 8660369977<br>Email : gadgetsmartmlore@gmail.com<br><br>';
$html.= '                                            GSTIN : 29AKNPT2160M1ZG <br>GSTIN/UIN : 29AKNPT2160M1ZG';
$html.= '                                    </p>';
$html.= '                                </div>';
$html.= '                            </div>';
$html.= '                        </div>';
...
$html.= '                                                <td style="border: none;" colspan="2">&nbsp;</td>';
$html.= '                                                <td style="text-align: right;border: 1px solid black;font-size: large;" ><b>CGST('.$GST.'%)&nbsp;:&nbsp;</b></td>';
$html.= '                                                <td style="text-align: right;border: 1px solid black" >₹'.($amount * $gsthalfcalc).'</td>';
$html.= '                                                ';
$html.= '                                            </tr>';
$html.= '                                            <tr style="border: none;">';
$html.= '                                                <td style="border: none;" colspan="2">&nbsp;</td>';
$html.= '                                                <td style="text-align: right;border: 1px solid black;font-size: large;" ><b>SGST('.$GST.'%)&nbsp;:&nbsp;</b></td>';
$html.= '                                                <td style="text-align: right;border: 1px solid black" >₹'.($amount * $gsthalfcalc).'</td>';
$html.= '                                                ';
$html.= '                                            </tr>';
$html.= '                                            <tr style="border: none;">';
