                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="javascript:;" style="font-family: Recursive;font-size: larger;">Payment Details</a>
                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php
                                                    include('db.php');
                                                    $query = "SELECT pm.payment_id, pm.referenceNumber, pm.custID, pm.towards, pm.amount, pm.gDate, cm.Name FROM payment pm, customer_master cm WHERE pm.custID = cm.CUID ";
