...
<body>
    ...
    <main id="main">
        <section id="hero1" class="d-flex flex-column justify-content-end" style="background-color: white;background-size: cover;padding-right: 50px;padding-left:50px ;padding-bottom: 10px;"><br>&nbsp;<br>
            <h2 style="color: black;font-family: Roboto Slab;padding-left: 10px;">Payment Details</h2>
            <div class="table-responsive" style="padding:10px;">
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col"><h4><b>Payment ID</b></h4></th>
                            <th scope="col"><h4><b>Reference Number</b></h4></th>
                            <th scope="col"><h4><b>Towards</b></h4></th>
                            <th scope="col"><h4><b>Reciept</b></h4></th>
                            <th scope="col"><h4><b>Amount</b></h4></th>
                            <th scope="col"><h4><b>Date & Time</b></h4></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        include('db.php');
                        $query15 = "SELECT * FROM `payment` where `custID` = '".$custid."' ORDER by `Paynum` desc";
